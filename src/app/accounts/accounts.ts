...
export default class Accounts extends LitElement {
  ...
  public newAccountDialog?: IgcDialogComponent;
    ...
    return html`
      ...
      <div class="row-layout group">
        <div class="column-layout group_1">
          <div class="column-layout group_2">
            ...
            <div class="row-layout header">
              ...
              <div class="row-layout buttons">
                <igc-button variant="flat" @click=${() => this.newAccountDialog?.toggle()} class="user-input user-input_3">
          ...
          <igc-grid .data="${this.northwindCustomers}" primary-key="contactName" display-density="cosy" allow-filtering="true" filter-mode="excelStyleFilter" class="ig-typography grid" @click="${() => Router.go('/account-sample')}">
          ...
          <div class="column-layout group_8">
            <div class="column-layout group_9">
              ...
              <div class="row-layout group_10">
                <div class="column-layout group_11">
                  ...
                  <igc-select ?outlined="${false}" label="Type" value="1" class="user-input_1">
                ...
                <div class="column-layout group_11">
                  ...
                  <igc-input label="Parent Account" placeholder="Search Accounts..." ?outlined="${false}" class="user-input_1">
                    <span slot="suffix">
                      <span class="material-icons icon">
                        search
                      </span>
                  ...
                  <igc-input type="tel" label="Phone" ?outlined="${false}" class="user-input_1"></igc-input>
                  <igc-select ?outlined="${false}" label="Industry" value="1" class="user-input_1">
                    <igc-select-item value="1" ?selected="${true}">
                      -- None --
                    </igc-select-item>
                    <igc-select-item value="2">
                  ...
                  <igc-select ?outlined="${false}" label="Employees" class="user-input_1">
                    <igc-select-item value="1">
                      Self Employed
                    </igc-select-item>
                    <igc-select-item value="2">
            ...
            <div class="row-layout group_13">
              <div class="column-layout group_11">
                ...
                <igc-input label="Address" placeholder="Search Address" ?outlined="${false}" class="user-input_1">
                  <span slot="suffix">
                    <span class="material-icons icon">
                      search
                    </span>
